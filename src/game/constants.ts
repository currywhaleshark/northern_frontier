...
export const JOB_DESC: Record<JobId, string> = {
  ...
  shaman: '당집에 상주하는 무당입니다. 월향에게서 이어진 신맥의 후계자만 맡을 수 있습니다.',
  monk: '암자에 상주하는 승려입니다. 해운이 거둔 동자승에게서 이어진 법맥의 후계자만 맡을 수 있습니다.',
...
export const FACTIONS: Faction[] = [
  ...
  },
  {
    ...
    tradeValues: {
      ...
      hide: 1.9, herbs: 1.5, hideClothes: 3.6, strawShoes: 1.15, leatherShoes: 3.3, cotton: 1.7, cottonClothes: 3.2, salt: 1.25,
    },
