...
| [튜토리얼 개편 착수 지시문](IMPLEMENTATION-2026-07-31-tutorial-overhaul.md) | 완료 | Claude Opus 단독 담당. M0~M5(11스텝·UI 훅·코치·겨울 점검 패널·초회 도움말 12모듈)에 이어 M6 감사 완료 — §9 7항목 대조, 인계 5건 판정, 겨울 점검 목표치 18/14→30/24 상향, 실기동 스모크 |
