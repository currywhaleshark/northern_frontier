...
| [새 게임 설정 S6 세부설정 구현계획](IMPLEMENTATION-2026-08-05-new-game-setup-s6-tuning.md) | 일부 완료 | S6-1~S6-3 구현 완료. 사용자 UI, 통합 자원 밀도, 온화/기준/혹독 연간 기후를 실제 소비처와 저장 스냅샷에 연결했고 지도·기후 표적 회귀와 빌드를 통과했으며 전체 게임 회귀·최종 감사가 남음 |
...
| [방어 개편 설계](DESIGN-2026-08-01-defense-overhaul.md) | 완료 | P1~P5 완료. 지도 파생 성벽 단면, 3라운드 돌파전과 마을 방어 전환, 망루 사격·장기 공성을 통합하고 같은 날 자동/수동 성벽 교전 단일 처리와 중간 저장을 고정. 전술 골든·관군 5개 편제 1,000회 측정·프로덕션 빌드 통과 |
