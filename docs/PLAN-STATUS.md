...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F4, F5 해안 이음매·염부·한선형 어선과 포구채+3~6칸 잔교의 비직사각 복합 발자국 완료. F5 지형 전이 타일과 어살터·자염막·포구 최종 건물 자산이 남음 (`test_fishing_boat_assets.mjs`, F2~F4, 스프라이트 스튜디오 타입 검사, 빌드) |
