...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 완료 | F0~F5 완료. 염부·한선형 어선·비직사각 복합 포구·해안 바닥·어살터·자염막·배무이터, 일반/겨울 포구와 1.4칸 계류대의 224px HD 최대 줌 대응, 물고기·갯벌 게를 구분하는 128px 생성형 어장 지도 아이콘을 구현함 (`test_coastal_ground_assets.mjs`, `test_tidal_fishery_building_assets.mjs`, `test_saltworks_building_assets.mjs`, `test_boatyard_building_assets.mjs`, `test_fishing_boat_assets.mjs`, `test_fishing_port_assets.mjs`, `test_fishing_grounds_f0_f1.mjs`, F2~F4, 스프라이트 스튜디오 타입 검사, 빌드) |
