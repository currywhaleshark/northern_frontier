...
| [후반 엔딩](DESIGN-2026-07-29-late-game-endings.md) | 미착수 | 2026-08-07 설계 보완 완료. 평시 민생·주변 정세·외교 예고를 주민이 말하고, 습격 전 조짐과 실제 감지 시 파수꾼 외침 및 경보/기습별 대사 뉘앙스를 구분하는 H0 말풍선 소문망을 선행 범위로 추가. 인물 중심 9년 시계·협정 계승·전란 3층은 H0 기반 위에서 착수 대기 |
