...
| [후반 엔딩](DESIGN-2026-07-29-late-game-endings.md) | 보류 | 진행 방식을 인물 중심으로 확정(계승→칭칸→북병사 교지). 외교 인물 F4·외교 활동 E2·E4~E6 완료까지 착수 보류 |
| [외교 인물](DESIGN-2026-07-30-diplomatic-figures.md) | 일부 완료 | 실록 기반 인명 풀, F1 결정적 생성·스키마 48·96일 임기, F2 북병사 성향 실효 보정, F3 대표 명의/UI·사건 문구 감사 완료. F4 초상만 후속 |
| [외교 활동](DESIGN-2026-07-30-diplomatic-actions.md) | 일부 완료 | E1 예물 사절과 E3 습격 귀띔 완료: 관계 70+의 다른 여진 지도자가 공격 세력을 알려 주고 협박 거절 뒤까지 warned 유지. E2·E4~E6 미착수 |
