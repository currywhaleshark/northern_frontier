...
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0~S4 완료. S5는 해수 비음용·비관개·비결빙, 남쪽 연속 해안과 해안 전용 자염 체인의 구현계획을 확정했고 코드 구현이 남음 |
...
| [새 게임 설정 S5 해안 구현계획](IMPLEMENTATION-2026-08-03-new-game-setup-s5-coast-region.md) | 미착수 | 해수 의미 계약, 남쪽 18~24% 연속 해안, 희소한 담수·수맥, 해안 전용 자염막·염부와 장작 기반 소금 생산 범위를 확정 |
