...
| [새 게임 설정 S5 해안 구현계획](IMPLEMENTATION-2026-08-03-new-game-setup-s5-coast-region.md) | 완료 | 남쪽 연속 바다·담수 분리·비결빙/통행 차단과 자염막·염부를 구현하고, 후속으로 자동 운반 품목 `salt` 누락을 실제 자염막→정착지 왕복 회귀와 함께 수정 |
