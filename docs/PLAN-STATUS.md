...
| [어선과 출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 미착수 | 갯벌 어살터를 배 없는 초기 연안 어로로 분리하고, 개별 선체·1인 1척·포구 작업영역·실항행·어장 비축의 고산출·풍랑 위험 단계를 F0~F4로 유지 |
...
| [해안 전이 지형과 갯벌 어로 구현계획](IMPLEMENTATION-2026-08-03-coastal-transition-tidal-flat.md) | 완료 | 무지물·건축 금지 모래/갯벌, 첫 내륙 평지 자염막, `mudflat` 공동 비축과 어부 2인 어살터의 도보 어로·하역·운반·회복·저장을 S5 해안 표적/관련 core·UI·스프라이트 검사·빌드·실화면으로 검증 |
