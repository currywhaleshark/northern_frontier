...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F4, F5 해안 이음매·염부·한선형 어선과 비직사각 복합 포구 완료. 어선 50% 축소·계류대 옆 정박·항행 보간·승선 어부 숨김, 타일을 채우는 잔교와 1.4칸 계류대까지 보정했으며 겨울 포구, 지형 전이 타일, 어살터·자염막 자산이 남음 (`test_fishing_boat_assets.mjs`, `test_fishing_port_assets.mjs`, F2~F4, 스프라이트 스튜디오 타입 검사, 빌드) |
