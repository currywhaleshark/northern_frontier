...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F3 통합 어장·기본 약 1/3 밀도·연안 어로·개별 어선·호수 중/심수 실항행·거리별 어획/내구·귀항/포구 하역·계절 제한·v60 저장 완료. F4 바다 풍랑·F5 최종 스프라이트가 남음 (`test_fishing_boats_f3_lake.mjs`) |
