...
| [스프라이트 스튜디오 구현계획](IMPLEMENTATION-2026-07-28-sprite-studio.md) | 완료 | P0~P6에 이어 P7에서 인접 채광의 실제 대상 문맥·광부 방향과 탭 B 좌·우·상·하 광상 미리보기를 연결·검증 |
| [어선과 출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 미착수 | 개별 선체 상태·1인 1척·포구 작업영역·실항행·어장 비축을 F0~F4로 분할. 새 게임 설정 S4(호수)·S5(해안)에 종속 |
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0~S3 완료. 산지 지표 광상은 자연 장벽이며 인접 채광으로 고갈하면 통로가 열린다. S4 호수와 S5 해안은 남음 |
...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 완료 | 지표 광상을 주민·습격자 자연 장벽으로 만들고 인접 채광·고갈 개통·구 저장 재배치·스튜디오 자세를 core 81/81·빌드·실화면으로 검증 |
