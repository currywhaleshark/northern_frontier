...
| [튜토리얼 개편 착수 지시문](IMPLEMENTATION-2026-07-31-tutorial-overhaul.md) | 일부 완료 | Claude Opus 단독 담당. M0~M3 완료(11스텝·guides 상태·UI 훅 연결·코치 11단계·통제 사건 검증). 다음 M4(겨울 점검 패널)·M5(초회 도움말) |
