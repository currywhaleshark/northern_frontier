...
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0~S2 완료. S3 산지는 내부 능선·물 부족·숲/광물/사냥감 풍부 방향과 구현계획 확정. 산지/호수/해안 S3~S5 구현은 남음 |
...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 미착수 | 내부 능선·숲·광물·사냥감 증가, 평지·강·비옥지·일반 수맥 감소와 시작 보장·region 캐시·저장 정합 계획 확정 |
