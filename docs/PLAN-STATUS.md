...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F2 통합 어장·기본 약 1/3 밀도·기존/포구 연안 어로·개별 어선 v59 저장·배무이터 건조/수리·계류/승하선·수상 경로 완료. F3 호수 출어·F4 바다 풍랑·F5 최종 스프라이트가 남음 |
