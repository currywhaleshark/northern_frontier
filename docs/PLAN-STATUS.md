...
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 미착수 | `NewGameOptions`·저장 스냅샷 S0, 시작 설정 화면 S1, 지도 크기·평원/산지/호수/해안 S2~S5 설계. 첫 구현계획 작성 완료 |
| [새 게임 설정 S0+S1 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s0-s1.md) | 미착수 | 기존 밸런스·RNG를 유지하는 옵션/저장 계약, 시작 설정 화면, v57 마이그레이션과 하위 모델 UI·테스트 분업 계획 확정 |
