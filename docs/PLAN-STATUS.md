...
| [방어 개편 설계](DESIGN-2026-08-01-defense-overhaul.md) | 미착수 | P1~P5 구현 계약·완료 기준과 함께 사용량 절감을 위한 주 에이전트/하위 모델 단계별 분배, 최대 2개 병행, 단일 통합 파일 동시 수정 금지, 최종 감사 절차까지 보완. 구현계획·코드는 미착수 |
