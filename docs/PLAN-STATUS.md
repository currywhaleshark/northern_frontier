...
| [채집 영역 체제 설계](DESIGN-2026-08-01-gathering-zones.md) | 일부 완료 | G1~G3 완료. 작업영역·서식지 비축에 이어 채집 거점 배정 필수화, 공사터 우선 개간, 촌 단계 채광장, 구 저장 자동 배정, 길잡이 v6와 표적 회귀·빌드까지 반영. G4 숙식 움막은 남음 |
