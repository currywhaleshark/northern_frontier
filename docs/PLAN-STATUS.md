...
| [타 부족 거주지 활동 설계](DESIGN-2026-08-06-foreign-site-activity.md) | 일부 완료 | A0~A3 실제 생활·순찰 활동대, 3일 경제, 선택·미니맵, 계절별 생활권 1칸 확장·축소, 기존 시설 유예·협정 고정·v64 저장 완료; A4~A5 상단·전령·계절 이동·습격 연계가 남음 |
