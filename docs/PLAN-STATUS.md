...
| [어선과 출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 미착수 | 개별 선체 상태·1인 1척·포구 작업영역·실항행·어장 비축을 F0~F4로 분할. 새 게임 설정 S4(호수)·S5(해안)에 종속 |
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0~S3 완료, S4 호수 계획 확정. 큰 연결 호수·자연 급수·호숫가 잔물결과 목재/광물 부족을 구현하고 S5 해안으로 진행 |
...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 완료 | 지표 광상 장벽·인접 채광·고갈 개통·구 저장 재배치와 방향별 광부·노두 가림을 core 81/81·빌드·스튜디오 네 방향 실화면으로 검증 |
| [새 게임 설정 S4 호수 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s4-lake-region.md) | 미착수 | 큰 연결 호수와 풍부한 자연 급수·수맥, 부족한 목재·광물·가용 평지, 무홍수·호숫가 잔물결·가장자리부터 진행되는 결빙/해빙을 P0~P4로 구현 |
| [채집 영역 체제 설계](DESIGN-2026-08-01-gathering-zones.md) | 완료 | G1~G4 완료. 작업영역·거점 배정·숙식 움막과 길잡이 v7에 이어 사냥터 비축 3배, 구 저장 비축률 환산, 영역 전체 고갈 경고·8일 쿨다운까지 반영·검증 |
