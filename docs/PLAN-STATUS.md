...
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0 옵션·저장 계약과 S1 시작 설정 화면 완료. v57 마이그레이션, 78개 core·빌드·UI 스모크 검증 완료. 지도 크기·산지/호수/해안 S2~S5는 남음 |
...
| [새 게임 설정 S2 지도 크기 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s2-map-sizes.md) | 미착수 | 56²·72²·96², 명시적 생성 치수, 중형 RNG 보존, 실제 행렬 기반 저장 보정과 크기별 결정론·경계·성능 검증 계획 확정 |
