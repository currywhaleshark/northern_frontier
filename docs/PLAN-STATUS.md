...
| [새 게임 설정 S5 해안 구현계획](IMPLEMENTATION-2026-08-03-new-game-setup-s5-coast-region.md) | 완료 | 남쪽 18~24% 연속 바다, 담수 분리·연중 비결빙/통행 차단, 해안 전용 자염막·염부·장작 생산과 렌더/스튜디오를 core 83개·S5 표적·관련 자산/UI·빌드·실화면으로 검증 |
