...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F4, F5 염부·한선형 어선·비직사각 복합 포구·해안 바닥 전용 타일과 표시 보정 완료. 겨울 포구, 어살터·자염막·배무이터 자산이 남음 (`test_coastal_ground_assets.mjs`, `test_fishing_boat_assets.mjs`, `test_fishing_port_assets.mjs`, F2~F4, 스프라이트 스튜디오 타입 검사, 빌드) |
