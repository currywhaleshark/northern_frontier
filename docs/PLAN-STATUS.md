...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F4와 F5 해안 바닥 단방향 디더 이음매 완료. F5 건물·염부·어선 최종 스프라이트가 남음 (`test_fishing_boats_f4_sea.mjs`, `test_historical_terrain.mjs`) |
...
| [해안 전이 지형과 갯벌 어로 구현계획](IMPLEMENTATION-2026-08-03-coastal-transition-tidal-flat.md) | 완료 | 무지물·건축 금지 모래/갯벌, 첫 내륙 평지 자염막, `mudflat` 공동 비축·어살터와 숲식 해안 바닥 단방향 디더 이음매를 S5 해안 표적/지형·UI·스프라이트 검사·빌드·실화면으로 검증 |
