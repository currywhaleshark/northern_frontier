...
| [타 부족 거주지 활동 설계](DESIGN-2026-08-06-foreign-site-activity.md) | 일부 완료 | A0~A2 실제 생활 활동대·3일 경제 결산·공유 서식지·어장 수확·상태 전이·v63 저장 구현 및 표적 회귀 완료; A3~A5 생활권 변화·순찰·상단·전령·습격 연계가 남음 |
