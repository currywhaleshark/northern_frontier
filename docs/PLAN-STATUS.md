...
| [스프라이트 스튜디오 구현계획](IMPLEMENTATION-2026-07-28-sprite-studio.md) | 일부 완료 | P0~P7 완료. P8에서 위쪽은 노두 뒤, 좌우·아래쪽은 노두 앞이라는 인접 채광 가림 순서를 게임·탭 B에 공통 적용 중 |
| [어선과 출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 미착수 | 개별 선체 상태·1인 1척·포구 작업영역·실항행·어장 비축을 F0~F4로 분할. 새 게임 설정 S4(호수)·S5(해안)에 종속 |
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0~S3 기능 완료, 산지 지표 광상의 방향별 작업 가림 보정 중. S4 호수와 S5 해안은 남음 |
...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 일부 완료 | 지표 광상 장벽·인접 채광·고갈 개통·구 저장 재배치는 완료. 방향별 광부·노두 가림 순서를 게임·스튜디오에 공통 반영 중 |
