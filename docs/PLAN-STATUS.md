...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0 통합 어장·v58 저장·기본 약 1/3 밀도·지도 표식/실수역 경계와 F1 기존 낚시터/어살터 유한 비축 전환·낚시터 개명 완료. 포구 연안 어로와 F2 어선·F3 호수 출어·F4 바다 풍랑이 남음 |
