...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 미착수 | 어장을 같은 수역 타일로 절삭해 육지 침범을 막고, 반경 1 연안은 도보 전용·더 넓은 중심수는 어선 전용으로 분리해 거리별 어획/내구, 호수 결빙과 바다 풍랑을 F0~F4로 구현 예정 |
