...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F4 통합 어장·연안 어로·개별 어선·호수/바다 중/심수 실항행·거리별 어획/내구·결빙 제한·결정론적 풍랑 예보/출항 취소/귀항 파손·부상 완료. F5 최종 스프라이트가 남음 (`test_fishing_boats_f4_sea.mjs`) |
