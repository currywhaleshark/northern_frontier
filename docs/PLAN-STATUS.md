...
| [튜토리얼 개편 착수 지시문](IMPLEMENTATION-2026-07-31-tutorial-overhaul.md) | 완료 | Claude Opus 단독 담당. M0~M6에 이어 플레이테스트 후속 R1 완료(시작 전원 무직·시작 건초 30·시나리오 중 자연 병자 잠금·일시정지 시작과 스텝 자동 일시정지) |
