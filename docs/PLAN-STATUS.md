...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 일부 완료 | S3 본체와 광맥 밀도 조정 완료. 지표 광상을 주민·습격자 자연 장벽으로 만들고 인접 채광·고갈 후 개통을 연결하는 P4 진행 |
