...
| [새 게임 설정 S6 세부설정 구현계획](IMPLEMENTATION-2026-08-05-new-game-setup-s6-tuning.md) | 일부 완료 | S6-1 사용자 설정 UI와 프리셋/노브 복원 계약을 구현·빌드로 검증. 통합 자원 밀도와 결정적 기후 혹독도 소비처 연결이 남음 |
