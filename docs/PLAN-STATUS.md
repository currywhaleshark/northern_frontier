...
| [후반 엔딩](DESIGN-2026-07-29-late-game-endings.md) | 보류 | 인물 중심 진행(계승→칭칸→북병사 교지)과 F4 초상·외교 E1~E5 기반은 완료. E6 및 역사 시계 세부 결정까지 착수 보류 |
| [외교 인물](DESIGN-2026-07-30-diplomatic-figures.md) | 완료 | 실록 기반 인명 풀, 결정적 인물·임기, 성향 보정, 대표 명의, 고증 초상 16종과 조정·세력·교역 UI 연결 완료 |
| [외교 활동](DESIGN-2026-07-30-diplomatic-actions.md) | 일부 완료 | E1~E5 완료. E5는 구역별 연간 협정 사절·결정 가격·통행/사냥 허가 통합·길/교역 보너스·E4/항의 연결·v51 저장을 E5/E4/E2 표적 회귀와 빌드로 검증했고 E6은 미착수 |
