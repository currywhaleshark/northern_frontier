...
| [후반 엔딩](DESIGN-2026-07-29-late-game-endings.md) | 일부 완료 | 2026-08-07 H0 1차 구현: 캔버스 RAF와 같은 프레임 보간으로 주민을 부드럽게 추적하는 말풍선, 결정적 일일 1/2/4회 슬롯, 상태·계절·잡담·위협·실제 식단 편중 공급자, 참전 요청·북병사 교체 사전 소문과 중요 로그, 빈도 설정, v67 반복 장부, 외교/시설 조기경보와 근접 발견의 1회 외침 및 경보/기습 말투·색 분리를 `test_ambient_speech.mjs`·빌드로 검증. 역사 전환 사전 소문은 H1 연동 후속 |
...
| [외부 거점 경사 탑뷰 스프라이트 v2 구현계획](IMPLEMENTATION-2026-08-06-foreign-site-sprites-v2.md) | 완료 | 5종 본체·5종 세력 부속·건조대·나룻배를 경사 탑뷰 평상/겨울로 재생성하고 표준 2배·HD 8배 시트, 의미별 렌더, 스튜디오 `used` 감사, 픽셀·타입·빌드·최대 줌 검증 완료 |
