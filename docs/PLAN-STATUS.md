...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F4, F5 해안 바닥 이음매와 남녀 염부 4상태·실제 취수 왕복 완료. F5 건물과 고증된 한선형 어선 자산이 남음 (`test_fishing_boats_f4_sea.mjs`, `test_historical_terrain.mjs`, 스프라이트 스튜디오 타입 검사) |
