...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 일부 완료 | F0~F4, F5 해안 이음매·남녀 염부·가거도 한선형 어선 12프레임과 NE/SW 원본+NW/SE 반전, 게임/스튜디오 공용 manifest 완료. F5 지형 전이 타일과 어살터·자염막·포구 건물 자산이 남음 (`test_fishing_boat_assets.mjs`, F2~F4, 스프라이트 스튜디오 타입 검사, 빌드) |
