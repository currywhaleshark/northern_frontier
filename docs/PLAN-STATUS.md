...
| [어장·어선·출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 완료 | F0~F5와 선박 개체화 완료. 포구 양측 2슬롯·선박당 어부 최대 2명·고스트 위치 지정 건조·개별 선박 선택/정보 UI·하단 원 선택 표시를 v61 저장과 F2~F4 표적 테스트·빌드로 검증했으며, 기존 한선형 어선·복합 포구·어장 아이콘·최대 줌 HD 자산 계약도 유지함 |
