...
| [방어 개편 설계](DESIGN-2026-08-01-defense-overhaul.md) | 일부 완료 | P1~P4 완료. P5에서 지도 돌파 지점의 벽 등급·내구·성문·주둔 망루를 전술 `wall` 구역에 연결하고, 3라운드 성벽전 직접 지휘와 붕괴 후 병력·사상·장계를 보존하는 마을 방어 재배치 전환까지 구현. 자동/수동 피해 단일 적용의 골든·조합 최종 감사가 남음 |
