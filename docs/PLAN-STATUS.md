...
| [채집 영역 체제 설계](DESIGN-2026-08-01-gathering-zones.md) | 일부 완료 | G1 벌목장 영역·공사터 우선 개간과 G2 사냥막·약초막 영역·서식지 비축/숲 조건부 회복·고갈 UI까지 표적 회귀 완료. G3 배치 필수화·채광장 1티어, G4 숙식 움막은 남음 |
