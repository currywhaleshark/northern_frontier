...
| [채집 영역 체제 설계](DESIGN-2026-08-01-gathering-zones.md) | 완료 | G1~G4 완료. 원형 작업영역·서식지 비축·거점 필수 배정·공사터 우선 개간·촌 단계 채광장에 이어 숙식 움막 자동 링크, 3일분 국지 보급/소비, 현지 취침, 1일 귀가·재보급, 저장 정규화와 UI·표적 회귀·빌드까지 반영 |
...
| [튜토리얼 개편 착수 지시문](IMPLEMENTATION-2026-07-31-tutorial-overhaul.md) | 완료 | M0~M6·R1~R6 완료. 2026-08-02 G3 후속으로 채집 거점 필수 배정, 촌 단계 채광장, 길잡이 v6 목표·코치·17단계 완주 회귀까지 갱신 |
