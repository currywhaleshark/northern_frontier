...
| [스프라이트 스튜디오 구현계획](IMPLEMENTATION-2026-07-28-sprite-studio.md) | 일부 완료 | P0~P6 완료. 지표 광상 인접 채광에 맞춰 실제 작업 대상 문맥과 탭 B 네 방향 미리보기를 연결하는 P7 진행 |
| [어선과 출어 설계](DESIGN-2026-08-02-fishing-boats.md) | 미착수 | 개별 선체 상태·1인 1척·포구 작업영역·실항행·어장 비축을 F0~F4로 분할. 새 게임 설정 S4(호수)·S5(해안)에 종속 |
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0~S3 본체 완료. 산지 지표 광상을 채굴 가능한 자연 장벽으로 만드는 P4 보완 진행. S4 호수와 S5 해안은 남음 |
...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 일부 완료 | S3 본체와 광맥 밀도 조정 완료. 지표 광상 자연 장벽·인접 채광·고갈 후 개통과 스프라이트 스튜디오 작업 문맥을 연결하는 P4 진행 |
