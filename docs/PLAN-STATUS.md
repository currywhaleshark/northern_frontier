...
| [후반 엔딩](DESIGN-2026-07-29-late-game-endings.md) | 일부 완료 | 2026-08-07 H0 1차 구현: 화면 내 주민 추적 말풍선, 결정적 일일 1/2/4회 슬롯, 상태·계절·잡담·위협·실제 식단 편중 공급자, 참전 요청·북병사 교체 사전 소문과 중요 로그, 빈도 설정, v67 반복 장부, 외교/시설 조기경보와 근접 발견의 1회 외침 및 경보/기습 말투·색 분리를 `test_ambient_speech.mjs`·빌드로 검증. 역사 전환 사전 소문은 H1 연동 후속 |
