...
| [방어 개편 설계](DESIGN-2026-08-01-defense-overhaul.md) | 일부 완료 | P1~P4 완료. P5 첫 단면 계약으로 지도 돌파 지점의 벽 등급·내구·성문·사거리 안 주둔 망루를 전술 `wall` 구역의 이름·설명·방어 보정·화면·저장에 연결. 제한 라운드 돌파전과 벽 붕괴 후 마을 방어전 전환, 피해 단일 적용 회귀가 남음 |
