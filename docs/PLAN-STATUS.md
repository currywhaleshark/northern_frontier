...
| [새 게임 설정 개편 설계](DESIGN-2026-08-01-new-game-setup.md) | 일부 완료 | S0~S3 완료. 산지는 내부 능선과 숲·광물·사냥감을 늘리고 평지·강·비옥지·일반 수맥을 줄여 구현·검증. S4 호수와 S5 해안은 남음 |
...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 완료 | 산지 지형·지하 자원·서식지·선택 UI와 저장 정합 구현. 플레이 피드백으로 광맥 수·반경을 낮추고 개별 매장량 중심으로 조정해 다중 시드 과밀 상한까지 검증 |
