...
| [새 게임 설정 S3 산지 구현계획](IMPLEMENTATION-2026-08-02-new-game-setup-s3-mountain-region.md) | 완료 | 산지 지형·지하 자원·서식지·선택 UI와 저장 정합을 구현하고 세 크기×다중 시드 비교, 80개 core·빌드·실화면 검증 완료 |
