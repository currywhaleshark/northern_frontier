...
| [새 게임 설정 S6 세부설정 구현계획](IMPLEMENTATION-2026-08-05-new-game-setup-s6-tuning.md) | 일부 완료 | S6-1 UI와 S6-2 통합 자원 밀도 완료. 숲·노두·서식지·어장·일반 수맥/광맥의 0.75/1/1.25배와 시작 보장을 다중 시드·S2~S5·지하 자원 회귀로 검증했으며 기후 연결이 남음 |
