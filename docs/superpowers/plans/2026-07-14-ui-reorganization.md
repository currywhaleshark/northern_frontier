...
검증 메모 (2026-07-16): 타일·건물·주민 선택 문맥과 기존 건물 행동을 하단 `SelectionContextBar`로 이전했다. 선택 시 건설 드로어가 닫히고, 건설 카테고리 또는 배치를 시작하면 선택이 해제된다. 1280×800·1920×1080에서 도킹 창과 컨텍스트 바의 우측 경계가 겹치지 않으며, 긴 주민 정보는 바 내부에서만 스크롤됨을 확인했다.
