...
assert_sheet("defender-mounted-poses-v1.png", (2688, 480), 16, 4)
...
assert_sheet("nimacha-unit-poses-v1.png", (840, 480), 5, 4)
assert_sheet("holaon-unit-poses-v1.png", (504, 480), 3, 4)
assert_sheet("bandit-unit-poses-v1.png", (1008, 480), 6, 4)
assert_sheet("court-expanded-poses-v1.png", (504, 480), 3, 4)
...
assert_pose_cell_padding("defender-mounted-poses-v1.png", 16)
...
assert_pose_cell_padding("nimacha-unit-poses-v1.png", 5)
assert_pose_cell_padding("holaon-unit-poses-v1.png", 3)
assert_pose_cell_padding("bandit-unit-poses-v1.png", 6)
assert_pose_cell_padding("court-expanded-poses-v1.png", 3)
