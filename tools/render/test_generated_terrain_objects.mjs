...
assert.equal(terrainObjectFor('hunting', 'spring', false), 'pine');
assert.equal(terrainObjectFor('hunting', 'summer', false), 'pine');
assert.equal(terrainObjectFor('hunting', 'autumn', false), 'pine');
assert.equal(terrainObjectFor('hunting', 'winter', false), 'snowPine');
