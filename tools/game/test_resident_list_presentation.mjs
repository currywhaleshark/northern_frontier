...
assert.deepEqual(ids({}), [1, 2, 3, 4, 5, 6], 'arrival order preserves the existing resident list order');
...
assert.deepEqual(ids({ status: 'young' }), [4], 'life-stage filter finds children and youths');
